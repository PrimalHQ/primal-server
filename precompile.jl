...
precompile(Tuple{typeof(JSON.json), Base.Dict{Any, Any}})
precompile(Tuple{typeof(JSON.json), Base.Dict{String, Int64}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:event_id, :likes, :replies, :mentions, :reposts, :zaps, :satszapped, :score, :score24h), Tuple{PrimalServer.Nostr.EventId, Vararg{Int64, 8}}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:event_id, :replied, :liked, :reposted, :zapped), Tuple{PrimalServer.Nostr.EventId, Vararg{Bool, 4}}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:event_id, :words), Tuple{PrimalServer.Nostr.EventId, Int64}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :follower), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.PubKeyId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :post_your_post_was_mentioned_in, :your_post, :who_liked_it), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :post_your_post_was_mentioned_in, :your_post, :who_replied_to_it, :reply), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId, PrimalServer.Nostr.EventId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :post_your_post_was_mentioned_in, :your_post, :who_reposed_it), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :post_your_post_was_mentioned_in, :your_post, :who_zapped_it, :satszapped), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId, Int64}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :post_you_were_mentioned_in, :who_liked_it), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :post_you_were_mentioned_in, :who_replied_to_it, :reply), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId, PrimalServer.Nostr.EventId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :post_you_were_mentioned_in, :who_reposted_it), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :your_post, :who_liked_it), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :your_post, :who_replied_to_it, :reply), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId, PrimalServer.Nostr.EventId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :your_post, :who_reposted_it), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :your_post, :who_zapped_it, :satszapped), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId, Int64}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :your_post, :your_post_were_mentioned_in, :your_post_was_mentioned_by), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :you_were_mentioned_in), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :created_at, :type, :you_were_mentioned_in, :you_were_mentioned_by), Tuple{PrimalServer.Nostr.PubKeyId, Int64, PrimalServer.DB.NotificationType, PrimalServer.Nostr.EventId, PrimalServer.Nostr.PubKeyId}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :followers_count), Tuple{PrimalServer.Nostr.PubKeyId, Int64}}})
precompile(Tuple{typeof(JSON.json), NamedTuple{(:pubkey, :follows_count, :followers_count, :note_count, :long_form_note_count, :reply_count, :time_joined, :relay_count, :total_zap_count, :total_satszapped), Tuple{PrimalServer.Nostr.PubKeyId, Int64, Int64, Int64, Int64, Int64, Nothing, Int64, Int64, Int64}}})
